...
object KnnPokerhand {
  ...
  // Takes a double and returns it's squared value.
  ...
  // finds the difference between the members of each pair
  // and returns the sum of the squared differences as a double.
  ...
  def main(args: Array[String]) {
    ...
    for (testLine <- testLines)
    {
       ...
       for(i <- 0 to 9) {
        ...
        // Take and store top K elements in an array.
